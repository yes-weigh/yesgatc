...
export const RcStandardWeightsCertVctNotice: React.FC = () => (
  <div className="rc-vehicle-required-notice" role="status">
    ...
    <p className="rc-vehicle-required-notice__text mb-0">
      Your regional centre&apos;s standard weights certificate has not been uploaded yet. Your RC
      admin can add it under Profile → Edit. You cannot start new verifications until it is.
    </p>
  </div>
);
