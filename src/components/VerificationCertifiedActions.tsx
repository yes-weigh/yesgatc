...
import { Award, BarChart3, Receipt, Tag } from 'lucide-react';
import {
...
function WhatsAppIcon() {
  return (
    <svg className="verification-certified-action-mark" viewBox="0 0 24 24" aria-hidden>
      <path
        fill="currentColor"
...
export const VerificationCertifiedActions: React.FC<VerificationCertifiedActionsProps> = ({
  ...
  const actions = buildVerificationCertifiedActions(record, { customerPhone });
