...
> = {
  ...
  scale: {
    ...
    defaultName: 'Instrument with F2 test weight',
  },
  instrumentRear: {
    label: 'Instrument with F2 Corner',
    shortLabel: 'F2 Corner',
    hint: 'Required for submit',
    storageFolder: 'instrument-rear-image',
    defaultName: 'Instrument with F2 Corner',
  },
  standardWeight: {
    label: 'Instrument with small Weights',
    shortLabel: 'Small Weights',
    hint: 'Required for submit',
    storageFolder: 'standard-weight-image',
    defaultName: 'Instrument with small Weights',
  },
  verificationSeal: {
