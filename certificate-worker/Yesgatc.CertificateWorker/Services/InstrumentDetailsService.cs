...
public sealed class InstrumentDetailsService
{
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        return new InstrumentDetails
        {
            ...
            AccuracyClass = "III",
            MaximumCapacity = FirestoreFieldReader.FormatNumber(maxCapacity),
            MinimumCapacity = FirestoreFieldReader.FormatNumber(minCapacity),
            VerificationScaleInterval = FirestoreFieldReader.FormatNumber(verificationScaleInterval),
            ActualScaleInterval = FirestoreFieldReader.FormatNumber(actualScaleInterval),
            NoOfVerificationIntervals = FormatIntervalCount(noOfVerificationIntervals.Value),
            MaximumPermissibleError = FirestoreFieldReader.FormatNumber(maximumPermissibleError),
