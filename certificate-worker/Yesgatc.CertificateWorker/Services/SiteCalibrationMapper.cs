...
internal static class SiteCalibrationMapper
{
        ...
        IReadOnlyDictionary<string, string> rcNames)
    {
        ...
        return new SiteCalibrationRecord
        {
            ...
            CertificatePdfPath = ReadOptionalString(snapshot, "certificatePdfPath"),
            CertificateNumber = ReadOptionalString(snapshot, "certificateNumber"),
            SignedCertificatePdfUrl = ReadOptionalString(snapshot, "signedCertificatePdfUrl"),
            SignedCertificatePdfPath = ReadOptionalString(snapshot, "signedCertificatePdfPath"),
            EmaapSignedPdfUploadedAt = ReadOptionalString(snapshot, "emaapSignedPdfUploadedAt"),
            EmaapIssuedCertificateNumber = ReadOptionalString(snapshot, "emaapIssuedCertificateNumber"),
            PipelineFailedPhase = ReadOptionalString(snapshot, "pipelineFailedPhase"),
            PipelineFailureMessage = ReadOptionalString(snapshot, "pipelineFailureMessage"),
