 ...
 */
function zohoInvoiceOrderReferenceFromCertificate(certificateNumber) {
  const trimmed = String(certificateNumber ?? '').trim();
...
module.exports = {
  zohoInvoiceOrderReferenceFromCertificate,
};
